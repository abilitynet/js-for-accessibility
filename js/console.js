...
var Console = (function () {
  var Console = (function () {
    function Console(element) {
      ...
      var focusPreviousElement = function noop(cm, evt) {
          //add all elements we want to include in our selection
          document.querySelector('#next-slide').focus();
      };
      ...
      outputContainer.setAttribute('aria-relevant', 'additions');
